...
class GS_Metabox_Cost extends PBCI_MetaBox {
...
function pbci_gs_setup_ship_mb_cost() {
	new GS_Metabox_Cost( 'Cost',  pbci_gs_post_type() );
}

add_action( 'pbci_gs_setup_ship_mb', 'pbci_gs_setup_ship_mb_cost', 1 , 0 );
